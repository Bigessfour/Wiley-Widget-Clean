...
// Clean Architecture: Business layer depends on abstractions, not implementations
...
public class FiscalYearService
{
    ...
    public async Task<FiscalYearSettings> GetSettingsAsync()
    {
        ...
        _cachedSettings = await _unitOfWork.GetFiscalYearSettingsAsync();
        ...
        if (_cachedSettings == null)
        {
            ...
            await _unitOfWork.SaveFiscalYearSettingsAsync(_cachedSettings);
        }
    ...
    public async Task<FiscalYearSettings> UpdateSettingsAsync(int startMonth, int startDay)
    {
        ...
        var settings = await _unitOfWork.GetFiscalYearSettingsAsync();
        ...
        await _unitOfWork.SaveFiscalYearSettingsAsync(settings);
