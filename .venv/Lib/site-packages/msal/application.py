...
from .authority import WORLD_WIDE, Authority
...
from .token_cache import _GRANT_TYPE_BROKER, TokenCache, _get_username
    ...
    def __init__(
        ...
        self.http_client = ThrottledHttpClient(
            ...
            default_throttle_time=(
                ...
                if isinstance(self, PublicClientApplication)
                else 5
            ),
        )
