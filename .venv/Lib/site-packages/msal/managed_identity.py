...
from .throttled_http_client import RetryAfterParser, ThrottledHttpClientBase
        ...
        *,
        ...
        try:
            result = _obtain_token(
                ...
                resource,
                access_token_sha256_to_refresh=(
                    hashlib.sha256(access_token_to_refresh.encode("utf-8")).hexdigest()
    ...
    resp = http_client.get(
        ...
        params={
            ...
            for k, v in {
                ...
                "xms_cc": (
                    ",".join(client_capabilities) if client_capabilities else None
                ),
            }.items()
            if v is not None
        },
