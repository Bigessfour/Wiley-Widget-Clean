...
class ManagedIdentityCredential(AsyncContextManager):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        exclude_workload_identity = kwargs.pop(
        ...
        if os.environ.get(EnvironmentVariables.IDENTITY_ENDPOINT):
            if os.environ.get(EnvironmentVariables.IDENTITY_HEADER):
                ...
                self._credential = AzureArcCredential(
                    client_id=client_id, identity_config=identity_config, **kwargs
                )
            ...
            if os.environ.get(EnvironmentVariables.MSI_SECRET):
                ...
                self._credential = AzureMLCredential(
                    client_id=client_id, identity_config=identity_config, **kwargs
                )
            else:
                ...
                self._credential = CloudShellCredential(
                    client_id=client_id, identity_config=identity_config, **kwargs
                )
        elif (
            all(
            ...
            workload_client_id = client_id or os.environ.get(
