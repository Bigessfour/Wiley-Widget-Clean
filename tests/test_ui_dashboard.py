...
class TestDashboardView:
    ...
    def test_dashboard_loads(self, ui_main_window):
        """Test that main window loads (basic smoke test)"""
        # Basic smoke test - just verify the main window exists
        assert ui_main_window is not None, "Main window should be available"
        # The application started and we found a main window - that's success enough
        # The detailed UI testing can be done separately if needed
