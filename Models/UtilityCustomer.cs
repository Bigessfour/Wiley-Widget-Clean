...
public class UtilityCustomer : INotifyPropertyChanged, IValidatableObject
{
    ...
    public string EmailAddress
    {
        ...
        set
        {
            var normalized = string.IsNullOrWhiteSpace(value) ? string.Empty : value;
            if (_emailAddress != normalized)
            {
                _emailAddress = normalized;
    ...
    public string BusinessLicenseNumber
    {
        ...
        set
        {
            if (_businessLicenseNumber != value)
            {
